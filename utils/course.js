...
const courseFormatter = (obj) => {
  var _obj$course_category,
    _obj$course_category2,
    _obj$course_subscript,
    _obj$course_subscript2,
    _obj$course_subscript3;
  return _objectSpread(
    {
      categoryName:
        (_obj$course_category = obj.course_category) === null ||
        _obj$course_category === void 0
          ? void 0
          : _obj$course_category.name,
      categoryId:
        (_obj$course_category2 = obj.course_category) === null ||
        _obj$course_category2 === void 0
          ? void 0
          : _obj$course_category2.id,
    ...
    obj.course_subscription_relation_array
      ? {
          plan_id:
            (_obj$course_subscript =
              obj.course_subscription_relation_array[0]) === null ||
            _obj$course_subscript === void 0
              ? void 0
              : _obj$course_subscript.razorpay_plan_id,
          subscription_cost:
            (_obj$course_subscript2 =
              obj.course_subscription_relation_array[0]) === null ||
            _obj$course_subscript2 === void 0
              ? void 0
              : _obj$course_subscript2.subscription_cost,
          interval:
            (_obj$course_subscript3 =
              obj.course_subscription_relation_array[0]) === null ||
            _obj$course_subscript3 === void 0
              ? void 0
              : _obj$course_subscript3.interval,
        }
      : {}
  );
};
